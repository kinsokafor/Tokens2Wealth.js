<template>
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-title">Inflows and Outflows</h3>
        </div>
    </div>
    <div>
        <data-filter 
            ...
            <list-item 
                ...
                <div class="links">
                    ...
                    <router-link :to="`/${data.ledger == 'credit' ? 'inflow' : 'outflow'}/${data.id}`" class="link-primary ml-4"><small>View</small></router-link>
                </div>
